<div class="search-tab inactive">
	<div class="topbar">
		<svg class="ab-l-m m-l-20" width="16" height="20" viewBox="0 0 16 20" fill="none" xmlns="http://www.w3.org/2000/svg">
		...
		<input type="text" name="search" placeholder="Search" class="searchbar fs-18 ab-l-m m-l-60 f-rob t-g"> 
		<div class="icon-btn ab-r-m m-r-10 ripple hamb-menu noselect" onclick="searchRetract()">
			<svg class="hamburger-svg noselect opened" width="30" height="30" viewBox="0 0 100 100">
